...
namespace ZNews.Persistence.Migrations
{
    ...
    [Migration("20210205095634_AddIsActiveForTag")]
    partial class AddIsActiveForTag
    {
            ...
            modelBuilder.Entity("ZNews.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2021, 2, 5, 13, 26, 28, 360, DateTimeKind.Local).AddTicks(707),
                            IsRemove = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2021, 2, 5, 13, 26, 28, 387, DateTimeKind.Local).AddTicks(4242),
                            IsRemove = false,
                            Name = "Reporter"
                        });
                });
