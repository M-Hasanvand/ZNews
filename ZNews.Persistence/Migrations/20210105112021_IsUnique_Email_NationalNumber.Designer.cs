...
namespace ZNews.Persistence.Migrations
{
    ...
    [Migration("20210105112021_IsUnique_Email_NationalNumber")]
    partial class IsUnique_Email_NationalNumber
    {
            ...
            modelBuilder.Entity("ZNews.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2021, 1, 5, 14, 50, 18, 406, DateTimeKind.Local).AddTicks(8107),
                            IsRemove = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2021, 1, 5, 14, 50, 18, 423, DateTimeKind.Local).AddTicks(1269),
                            IsRemove = false,
                            Name = "Reporter"
                        });
                });
