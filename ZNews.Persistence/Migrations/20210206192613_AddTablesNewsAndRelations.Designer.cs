...
namespace ZNews.Persistence.Migrations
{
    ...
    [Migration("20210206192613_AddTablesNewsAndRelations")]
    partial class AddTablesNewsAndRelations
    {
            ...
            modelBuilder.Entity("ZNews.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2021, 2, 6, 22, 56, 10, 793, DateTimeKind.Local).AddTicks(4600),
                            IsRemove = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2021, 2, 6, 22, 56, 10, 804, DateTimeKind.Local).AddTicks(1633),
                            IsRemove = false,
                            Name = "Reporter"
                        });
                });
            ...
            modelBuilder.Entity("ZNews.Domain.Entities.Newses.Category", b =>
                {
                    b.HasOne("ZNews.Domain.Entities.Users.User", "User")
                        .WithOne()
                        .HasForeignKey("ZNews.Domain.Entities.Newses.Category", "UserId")
            ...
            modelBuilder.Entity("ZNews.Domain.Entities.Newses.Comment", b =>
                {
                    ...
                    b.HasOne("ZNews.Domain.Entities.Users.User", "User")
                        .WithOne()
                        .HasForeignKey("ZNews.Domain.Entities.Newses.Comment", "UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("ZNews.Domain.Entities.Newses.News", b =>
                {
                    ...
                    b.HasOne("ZNews.Domain.Entities.Users.User", "User")
                        .WithOne()
                        .HasForeignKey("ZNews.Domain.Entities.Newses.News", "UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("ZNews.Domain.Entities.Newses.Tag", b =>
                {
                    b.HasOne("ZNews.Domain.Entities.Users.User", "User")
                        .WithOne()
                        .HasForeignKey("ZNews.Domain.Entities.Newses.Tag", "UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
