...
namespace ZNews.Persistence.Migrations
{
    ...
    [Migration("20210320161828_IsNullableUserIdInComment")]
    partial class IsNullableUserIdInComment
    {
            ...
            modelBuilder.Entity("ZNews.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2021, 3, 20, 19, 48, 25, 948, DateTimeKind.Local).AddTicks(3537),
                            IsRemove = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2021, 3, 20, 19, 48, 25, 961, DateTimeKind.Local).AddTicks(5008),
                            IsRemove = false,
                            Name = "Reporter"
                        });
                });
