...
namespace ZNews.Persistence.Migrations
{
    ...
    [Migration("20210202134205_AddPropUserGuidForUser")]
    partial class AddPropUserGuidForUser
    {
            ...
            modelBuilder.Entity("ZNews.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2021, 2, 2, 17, 12, 3, 982, DateTimeKind.Local).AddTicks(852),
                            IsRemove = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2021, 2, 2, 17, 12, 3, 993, DateTimeKind.Local).AddTicks(1691),
                            IsRemove = false,
                            Name = "Reporter"
                        });
                });
