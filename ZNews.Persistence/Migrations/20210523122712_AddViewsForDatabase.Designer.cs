...
namespace ZNews.Persistence.Migrations
{
    ...
    [Migration("20210523122712_AddViewsForDatabase")]
    partial class AddViewsForDatabase
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZNews.Domain.Entities.HomePage.Views.HomePageView", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ZNews.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2021, 5, 23, 16, 57, 8, 828, DateTimeKind.Local).AddTicks(3717),
                            IsRemove = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2021, 5, 23, 16, 57, 8, 846, DateTimeKind.Local).AddTicks(1046),
                            IsRemove = false,
                            Name = "Reporter"
                        });
                });
            ...
            modelBuilder.Entity("ZNews.Domain.Entities.Users.User", b =>
                {
                    b.HasOne("ZNews.Domain.Entities.Users.User", "OneUser")
