...
namespace ZNews.Persistence.Migrations
{
    ...
    [Migration("20210103171738_createDb_User_Role")]
    partial class createDb_User_Role
    {
            ...
            modelBuilder.Entity("ZNews.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2021, 1, 3, 20, 47, 37, 68, DateTimeKind.Local).AddTicks(7634),
                            IsRemove = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2021, 1, 3, 20, 47, 37, 85, DateTimeKind.Local).AddTicks(3660),
                            IsRemove = false,
                            Name = "Reporter"
                        });
                });
