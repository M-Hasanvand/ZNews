...
{
    public partial class AddTablesNewsAndRelations : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsInTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NewsInTags_News_NewsId",
                        column: x => x.NewsId,
                        principalTable: "News",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NewsInTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsInTags_NewsId",
                table: "NewsInTags",
                column: "NewsId");

            migrationBuilder.CreateIndex(
                name: "IX_NewsInTags_TagId",
                table: "NewsInTags",
                column: "TagId");
