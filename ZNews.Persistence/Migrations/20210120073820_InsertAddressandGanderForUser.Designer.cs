...
namespace ZNews.Persistence.Migrations
{
    ...
    [Migration("20210120073820_InsertAddressandGanderForUser")]
    partial class InsertAddressandGanderForUser
    {
            ...
            modelBuilder.Entity("ZNews.Domain.Entities.Users.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2021, 1, 20, 11, 8, 18, 673, DateTimeKind.Local).AddTicks(7984),
                            IsRemove = false,
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2021, 1, 20, 11, 8, 18, 684, DateTimeKind.Local).AddTicks(9637),
                            IsRemove = false,
                            Name = "Reporter"
                        });
                });
